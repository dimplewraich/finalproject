<?php echo form_open($form_action,' name="frm-client" class="form-horizontal" data-ajax="wdpajax" data-options=\'{"params" : "ajax", "loader" : "modal"}\'', $hiddenvars);?>
...
<?php echo load_js('clients/form.js');?>