<?php echo form_open($form_action,' name="frm-view" class="form-horizontal" data-ajax="wdpajax" data-options=\'{"params" : "ajax", "loader" : "modal"}\'', $hiddenvars);?>
...
<?php echo load_js('clients/show.js');?>