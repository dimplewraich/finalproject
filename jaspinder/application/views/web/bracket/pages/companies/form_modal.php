<?php echo form_open_multipart($form_action,' name="frm-company" class="form-horizontal" data-options=\'{"params" : "ajax", "loader" : "modal"}\'', $hiddenvars);?>
<div class="row">
	<div class="col-sm-12">
...
<?php echo form_close();?>
<?php echo load_js('companies/form.js');?>